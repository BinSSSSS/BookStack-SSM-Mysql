		...
		<div class="navbar-inner">
			<div class="container">
				<a class="btn btn-navbar" data-toggle="collapse"
					...
					class="icon-reorder shaded"></i></a><a class="brand" href="index">Edmin
				</a>
							...
							<div class="module-body">
								<div class="profile-head media">
									...
									<div class="media-body">
										...
										<p class="profile-brief">Lorem Ipsum is simply dummy text
											of the printing and typesetting industry. Lorem Ipsum has
											been the industry's standard dummy text ever since the 1500s,
											when an unknown printer took a galley of type.</p>
										<div class="profile-details muted">
											<a href="#" class="btn"><i class="icon-plus shaded"></i>Send
												Friend Request </a> <a href="#" class="btn"><i
												class="icon-envelope-alt shaded"></i>Send message </a>
										</div>
									</div>
								</div>
									...
									<div class="tab-pane fade active in" id="activity">
										<div class="stream-list">
													...
													<div class="stream-headline">
														...
														<div class="stream-attachment video">
															<div class="responsive-video">
																...
																<p>
																	<a href="http://vimeo.com/20630217">Google Car</a> from
																	<a href="http://vimeo.com/user3524956"> Henk Rogers</a>
											...
											<div class="media stream load-more">
												<a href="#"><i class="icon-refresh shaded"></i>Load
													more... </a>
											</div>
										</div>
										<!--/.stream-list-->
