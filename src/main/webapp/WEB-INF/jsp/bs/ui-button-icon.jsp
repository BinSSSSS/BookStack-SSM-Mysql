	...
	<div class="navbar navbar-fixed-top">
		<div class="navbar-inner">
			<div class="container">
				...
				</a> <a class="brand" href="index.html"> 书栈后台 </a>
					...
					<div class="sidebar">
						...
						<ul class="widget widget-menu unstyled">
							...
							<li><a href="message.html"> <i
									...
									class="label green pull-right">11</b>
							</a></li>
						...
						<ul class="widget widget-menu unstyled">
							<li><a class="collapsed" data-toggle="collapse"
								...
								<ul id="togglePages" class="collapse unstyled">
									<li><a href="other-login.html"> <i class="icon-inbox"></i>
											Login
									</a></li>
					...
					<div class="content">
						...
						<div class="btn-controls">
							<div class="btn-box-row row-fluid">
								<a href="#" class="btn-box span3"> <i class="icon-arrow-up"></i>
									<b>Big</b>
								</a> <a href="#" class="btn-box span3"> <i class="icon-bell"></i>
									<b>Big</b>
								</a> <a href="#" class="btn-box span3"> <i
									class="icon-screenshot"></i> <b>Big</b>
								</a> <a href="#" class="btn-box span3"> <i class="icon-beaker"></i>
									<b>Big</b>
								</a>
							</div>
							...
							<div class="btn-box-row row-fluid">
								<a href="#" class="btn-box big span4"> <i
									class="icon-adjust"></i> <b>Bigger</b>
								</a> <a href="#" class="btn-box big span4"> <i
									class="icon-briefcase"></i> <b>Bigger</b>
								</a> <a href="#" class="btn-box big span4"> <i class="icon-gift"></i>
									<b>Bigger</b>
								</a>
							</div>
							...
							<div class="btn-box-row row-fluid">
								<a href="#" class="btn-box small span2"> <i
									class="icon-facebook"></i> <b>Small</b>
								</a> <a href="#" class="btn-box small span2"> <i
									class="icon-ambulance"></i> <b>Small</b>
								</a> <a href="#" class="btn-box small span2"> <i
									class="icon-search"></i> <b>Small</b>
								</a> <a href="#" class="btn-box small span2"> <i
									class="icon-key"></i> <b>Small</b>
								</a> <a href="#" class="btn-box small span2"> <i
									class="icon-zoom-in"></i> <b>Small</b>
								</a> <a href="#" class="btn-box small span2"> <i
									class="icon-edit"></i> <b>Small</b>
								</a>
							</div>
						</div>
						<!--/.btn-controls-->
						...
						<div class="module">
							...
							<div class="module-body">
								<p>
									...
									<code>.btn</code>
									class applied. However, typically you'll want to apply these to
									only
									<code>&lt;a&gt;</code>
									and
									<code>&lt;button&gt;</code>
								...
								<table class="table table-bordered">
									...
									<tbody>
										...
										<tr>
											...
											<td><a class="btn btn-large btn-primary">Button
													Large</a></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><a class="btn btn-large btn-success">Button
													Large</a></td>
										</tr>
										<tr>
											...
											<td><a class="btn btn-large btn-warning">Button
													Large</a></td>
										</tr>
										<tr>
										...
										<tr>
											...
											<td><a class="btn btn-large btn-inverse">Button
													Large</a></td>
										</tr>
									</tbody>
								</table>
