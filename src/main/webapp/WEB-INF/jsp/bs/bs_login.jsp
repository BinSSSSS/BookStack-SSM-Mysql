...
body {
	background-image:
		url(${pageContext.request.contextPath}/bs/images/stage_bg.jpg);
}
</style>
</head>
	...
	<div class="login testtwo">
		...
		<div class="login_fields" style="opacity: 1;">
			<div class="login_fields__user" style="opacity: 1;">
				...
				<input placeholder="admin" type="text" name="adminName"
					id="ipt-adminName">
				<div class="validation" style="opacity: 0;">
					<img src="images/tick_2.png">
				</div>
