$(function(){
	...
	$('input[type="submit"]').click(function (event) {
	    ...
	    if($ipt_password.val().length == 0 || $ipt_username.val().length == 0){
        ...
        $.post(post + "/bslogin.ado",{
            ...
            setTimeout(function () {
                ...
                if(resp == "APPROVE"){
                	...
                	$("body").append("<a href='/BookStack-SSM/bs/' id='stage' target='_self'></a>");
